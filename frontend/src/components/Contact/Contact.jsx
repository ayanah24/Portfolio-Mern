    ...
    <section id="contact" className="min-h-screen flex items-center px-6 bg-black relative overflow-hidden py-24">
      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          {/* LEFT SIDE - Profile Info and Socials */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left mb-12 md:mb-0">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 relative inline-block">
              Get In Touch
              <span className="absolute -bottom-2 left-0 w-1/2 h-[3px] bg-gradient-to-r from-sky-400 to-purple-500 rounded-full text-center"></span>
            </h2>
            <p className="text-gray-400 mt-4 max-w-xl text-lg font-light mb-10">
              Have a question or want to work together? Leave your message below.
            </p>

            {/* Profile Image */}
            <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-xl overflow-hidden shadow-[0_0_40px_rgba(14,165,233,0.15)] group mb-10">
            ...
            <div className="flex justify-center md:justify-start gap-6">
              <div className="relative group flex items-center justify-center">
                <a href="mailto:ayan27452@gmail.com" className="text-gray-400 hover:text-sky-400 hover:-translate-y-1 transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
                </a>
                {/* Tooltip */}
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 px-3 py-1.5 bg-gray-800 text-gray-200 text-xs rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 whitespace-nowrap border border-white/10 shadow-lg pointer-events-none z-20">
                  ayan27452@gmail.com
                  <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-gray-800 border-b border-r border-white/10 rotate-45"></div>
                </div>
              </div>
              ...
              <a href="https://x.com/ayan27452" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-sky-400 hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="w-full">
            <form
              ...
              className="w-full bg-white/5 border border-white/10 p-8 md:p-10 rounded-2xl shadow-2xl backdrop-blur-lg relative overflow-hidden"
            >
